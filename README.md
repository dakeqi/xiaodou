...
由于取消了LCD屏幕，设备无法显示激活二维码。我们提供以下几种激活方式：

#### 方式1️⃣：串口查看激活信息（推荐开发者）
...
2. **设备启动后，串口会输出激活信息**
   ...
   设备ID: 1234567890
   激活码: ABC123
   配网URL: https://xiaozhi.me/activate?code=ABC123
...
3. **复制URL到浏览器访问，或在小智APP中输入激活码**

#### 方式2️⃣：WiFi热点配网（推荐普通用户）🌟

> 此功能需要在固件中启用SoftAP模式

1. **设备上电后自动创建WiFi热点**
   - 热点名称：`XiaoZhi-XXXXXX`（XXXXXX为设备ID后6位）
   - 默认密码：`12345678`
...
> 此功能为可选功能，需要在固件中启用TTS

1. **设备启动后会语音播报**
   ```
   "您好，我是小智设备，请使用小智APP激活。
   您的激活码是：A-B-C-1-2-3
   也可以访问网址：小智点me斜杠激活"
   ```
